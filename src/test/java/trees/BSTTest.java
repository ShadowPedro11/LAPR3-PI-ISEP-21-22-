...
public class BSTTest {
     ...
     */
    @Test
    public void testHeight() { // 20,15,10,13,8,17,40,50,30,7
    ...
    public void testQuickSort(){
        ...
        List<Integer> expected = Arrays.asList(inorderT);
        assertEquals("list should be "+expected.toString(), expected, instance.inOrder());
    }
}
