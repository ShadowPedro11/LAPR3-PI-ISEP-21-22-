...
public class AVLTest {
    ...
    public void testEquals() {
        ...
        instance2.remove(8);
        assertNotEquals(instance, instance2, "equals! ");
    }

    @Test
    public void threeComplementary(){
        AVL<Character> newInstance = new AVL<>();
        char[] arr = {'A', 'Z', 'B', 'C', 'X', 'D', 'Q', 'E', 'V', 'M', 'Q'};
        for(char a : arr)
            newInstance.insert(a);

        for(char c : newInstance.posOrder()){
